...
function updateCalendar() {
  for (var i = 0; i < calendarArray.length; i++) {
    switch (calendarArray[i]) {
      case 0:
      document.getElementById(i).style.color = "#FEDCD2";
      break;
      case 1:
      document.getElementById(i).style.color = "#DCB239";
      break;
      case 2:
      document.getElementById(i).style.color = "#e88063";
      break;
      case 3:
      document.getElementById(i).style.color = "#C8C8A9";
      break;
      case 4:
      document.getElementById(i).style.color = "#83AF9B";
      break;
    }
  }
